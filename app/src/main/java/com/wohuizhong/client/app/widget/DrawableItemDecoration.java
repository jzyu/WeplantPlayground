...
public class DrawableItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DrawableItemDecoration(Context context, int dividerDrawableId, int dividerHeight, int dividerMargin) {
        this.dividerDrawable = WidgetUtil.getDrawable(context, dividerDrawableId);
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        //parent.getChildCount() 返回的是当前所绘制child的位置
        /*if (!isShowLast && position == count - 1) {
            return;
        }*/

        outRect.bottom = dividerHeight;
        //L.d(TAG, "getItemOffsets position :" + position + "space" + space +"count:"+ count);
    }
}
